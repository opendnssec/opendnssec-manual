...
project = 'OpenDNSSEC'
copyright = '2008-2021, NLnet Labs'
...
htmlhelp_basename = 'OpenDNSSECUserManualdoc'
...
latex_documents = [
    (master_doc, 'OpenDNSSECUserManual.tex', 'OpenDNSSEC User Manual',
     'NLnet Labs', 'manual'),
]
...
man_pages = [
    (master_doc, 'opendnssecusermanual', 'OpenDNSSEC User Manual',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OpenDNSSECUserManual', 'OpenDNSSEC User Manual',
     author, 'OpenDNSSECUserManual', 'One line description of project.',
     'Miscellaneous'),
]
